...
data "template_file" "userdata" {
  ...
  vars = {
    ...
    ansible_playbook_params = "--extra-vars \"ansible_python_interpreter=/usr/bin/python3 clojurians_app_fqdn=clojurians-log-staging.clojureverse.org use_demo_logs=true acme_sh_default_force_issue=true acme_sh_default_staging=true\""
